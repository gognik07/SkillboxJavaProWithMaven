package lesson8.tasks3;

import lesson8.tasks3.core.Line;
import lesson8.tasks3.core.Station;
...
//    private static Logger logger;
    ...
    private static Logger loggerInfoRequiredStations;
    ...
    public static void main(String[] args)
    {
        ...
        for(;;)
        {
            try {
                ...
                loggerInfoRequiredStations.info("Станция отправления: " + from.getName());
                loggerInfoRequiredStations.info("Станция прибытия: " + to.getName());
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            loggerInfoErroneousStations.info("Станция " + message + " не найдена");
        }
    }
